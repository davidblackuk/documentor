...
// the choice, and swaps the highlight.js stylesheet to match.
 ...
 * persisted (or default dark) theme immediately.
 *
...
export function initTheme() {
  ...
  let theme = localStorage.getItem("documenter.theme") === "light" ? "light" : "dark";
